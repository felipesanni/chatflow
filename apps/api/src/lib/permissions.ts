...
export const permissionDefinitions = [
  ...
  { key: 'tickets.viewOthers', group: 'Atendimento', label: 'Visualizar tickets de outros usuarios' },
  ...
  { key: 'tickets.replyUnassigned', group: 'Atendimento', label: 'Responder tickets nao atribuidos ao usuario' },
  { key: 'tickets.nudge', group: 'Atendimento', label: 'Chamar atencao do responsavel' },
  { key: 'tickets.transfer', group: 'Atendimento', label: 'Transferir atendimentos' },
  { key: 'tickets.transferOthers', group: 'Atendimento', label: 'Transferir tickets de outros usuarios' },
  ...
  { key: 'tickets.closedView', group: 'Atendimento', label: 'Visualizar modulo de tickets fechados' },
  { key: 'tickets.relatedHistory', group: 'Atendimento', label: 'Consultar historico de tickets relacionados' },
  ...
  { key: 'agents.delete', group: 'Equipe e filas', label: 'Excluir usuarios' },
  { key: 'agents.password.manage', group: 'Equipe e filas', label: 'Alterar senhas de usuarios' },
  { key: 'agents.viewBot', group: 'Equipe e filas', label: 'Visualizar agentes de automacao (bot)' },
  ...
  { key: 'queues.viewBot', group: 'Equipe e filas', label: 'Visualizar filas de automacao (bot)' },
